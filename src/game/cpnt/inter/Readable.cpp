...
auto Readable::onInteract(GameContext& ctx) -> task::Task
{
    ...
    case RoomKind::ROOM_AREA1:
        ctx.msg.add(gen::TextData::SCR_TEXT_1535);
        break;
    case RoomKind::ROOM_RUINS2:
        ctx.msg.add(gen::TextData::obj_readable_room1_65);
        break;
    case RoomKind::ROOM_RUINS3:
        if (_entity.getId() == ent::gen::EntityId::sign)
            ctx.msg.add(gen::TextData::SCR_TEXT_1540);
        else if (_entity.getId() == ent::gen::EntityId::wall_post)
            ctx.msg.add(gen::TextData::obj_readable_room1_66);
        else if (_entity.getId() == ent::gen::EntityId::left)
            ctx.msg.add(gen::TextData::obj_switchadvice1_61);
        else if (_entity.getId() == ent::gen::EntityId::right)
            ctx.msg.add(gen::TextData::obj_switchadvice2_61);
        else
            BN_ERROR("Invalid readable in `room_ruins3`");
        break;
    case RoomKind::ROOM_RUINS5:
        ctx.msg.add(gen::TextData::obj_readable_room1_67);
        break;
    case RoomKind::ROOM_RUINS7A:
        if (flags.candy_taken >= 4)
            ctx.msg.add(gen::TextData::SCR_TEXT_1606);
        else
        {
            if (flags.candy_taken == 0)
                ctx.msg.add(gen::TextData::SCR_TEXT_1604);
            else
                ctx.msg.add(gen::TextData::SCR_TEXT_1603);
            ctx.msg.add(gen::TextData::SCR_TEXT_1607);
            ...
            {
                if (items.full())
                    ctx.msg.add(gen::TextData::SCR_TEXT_1635);
                else
                {
                    ...
                    if (flags.candy_taken == 1)
                        ctx.msg.add(gen::TextData::SCR_TEXT_1624);
                    else if (flags.candy_taken == 2)
                        ctx.msg.add(gen::TextData::SCR_TEXT_1625);
                    else if (flags.candy_taken == 3)
                    {
                        if (flags.hardmode)
                        {
                            flags.candy_taken += 1;
                            dropCandyDish(ctx);
                            ctx.msg.add(gen::TextData::SCR_TEXT_1631);
                        }
                        else
                            ctx.msg.add(gen::TextData::SCR_TEXT_1626);
                    }
                    else if (flags.candy_taken == 4)
                    {
                        dropCandyDish(ctx);
                        ctx.msg.add(gen::TextData::SCR_TEXT_1628);
                    }
                    else
            ...
            {
                ctx.msg.add(gen::TextData::SCR_TEXT_1639);
            }
            else
    ...
    case RoomKind::ROOM_RUINS9:
        ctx.msg.add(gen::TextData::obj_readable_room1_68);
        break;
    case RoomKind::ROOM_RUINS10:
        if (_entity.getId() == ent::gen::EntityId::up)
            ctx.msg.add(gen::TextData::SCR_TEXT_1552);
        else if (_entity.getId() == ent::gen::EntityId::down)
            ctx.msg.add(gen::TextData::SCR_TEXT_1548);
        else
            BN_ERROR("Invalid readable in `room_ruins10`");
        break;
    case RoomKind::ROOM_RUINS12A:
        if (flags.true_pacifist)
            ctx.msg.add(gen::TextData::obj_cheesetable1_62);
        else
        {
            ctx.msg.add(gen::TextData::obj_cheesetable1_58);
            ctx.msg.add(gen::TextData::obj_cheesetable1_59);
        }
        break;
    case RoomKind::ROOM_RUINS12B:
        if (_entity.getId() == ent::gen::EntityId::sign)
            ctx.msg.add(gen::TextData::obj_sign_room_66);
        else if (_entity.getId() == ent::gen::EntityId::left)
        {
            static constexpr int SPIDER_DONUT_PRICE = 7;

            ctx.msg.add(gen::TextData::SCR_TEXT_1705);
            ctx.msg.add(gen::TextData::SCR_TEXT_1706);
        ...
        else if (_entity.getId() == ent::gen::EntityId::right)
        {
            ...
            ctx.msg.add(gen::TextData::SCR_TEXT_1736);
            ctx.msg.add(gen::TextData::SCR_TEXT_1737);
    ...
    case RoomKind::ROOM_RUINS13:
        if (_entity.getId() == ent::gen::EntityId::sign)
        {
            ctx.msg.add(gen::TextData::obj_readable_sign2_55);
            ctx.msg.add(gen::TextData::obj_readable_sign2_56);
        }
        else // ant froggit
        {
            ctx.msg.add(gen::TextData::obj_readable_room1_69_console_1);
            ctx.msg.add(gen::TextData::obj_readable_room1_69_console_2);
            ctx.msg.add(gen::TextData::obj_readable_room1_69_console_3);
            ctx.msg.add(gen::TextData::obj_readable_room1_69_console_4);
        }
        break;
    case RoomKind::ROOM_RUINS14:
        ctx.msg.add(gen::TextData::obj_readable_room1_70);
        break;
    case RoomKind::ROOM_RUINS15A:
        ctx.msg.add(gen::TextData::obj_readable_room1_71);
        break;
    case RoomKind::ROOM_RUINS15B:
        ctx.msg.add(gen::TextData::obj_readable_room1_72);
        break;
    case RoomKind::ROOM_RUINS15C:
        ctx.msg.add(gen::TextData::obj_readable_room1_73);
        break;
    case RoomKind::ROOM_RUINS15D:
        ctx.msg.add(gen::TextData::obj_readable_room1_74);
        break;
    case RoomKind::ROOM_RUINS19:
        if (flags.true_pacifist)
            ctx.msg.add(gen::TextData::obj_nastytree_59);
        else
            ctx.msg.add(gen::TextData::obj_nastytree_55);
        break;
    case RoomKind::ROOM_TORHOUSE1:
        if (_entity.getId() == ent::gen::EntityId::books)
            ctx.msg.add(gen::TextData::obj_readable_room1_75);
        else if (_entity.getId() == ent::gen::EntityId::calendar)
            ctx.msg.add(gen::TextData::obj_readable_room2_114);
        else
    ...
    case RoomKind::ROOM_ASGHOUSE1:
        ...
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room1_79);
            else
                ctx.msg.add(gen::TextData::obj_readable_room1_78);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::flower)
            ctx.msg.add(gen::TextData::obj_readable_room2_115);
        else
            BN_ERROR("Invalid readable in `room_asghouse1`");
        break;
    case RoomKind::ROOM_TORHOUSE2:
        if (_entity.getId() == ent::gen::EntityId::home_tools)
            ctx.msg.add(gen::TextData::obj_readable_room1_81);
        else if (_entity.getId() == ent::gen::EntityId::flame)
            ctx.msg.add(gen::TextData::obj_hearthflame_57);
        else if (_entity.getId() == ent::gen::EntityId::history_book)
        {
            ctx.msg.add(gen::TextData::obj_readable_room2_80);
            ctx.msg.add(gen::TextData::obj_readable_room2_81);
            ctx.msg.add(gen::TextData::obj_readable_room2_82);
            ctx.msg.add(gen::TextData::obj_readable_room2_83);
            ctx.msg.add(gen::TextData::obj_readable_room2_84);
            ctx.msg.add(gen::TextData::obj_readable_room2_85);
        }
        else
    ...
    case RoomKind::ROOM_ASGHOUSE2:
        ...
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room2_105);
            else
            {
                ctx.msg.add(gen::TextData::obj_readable_room2_100);
                ctx.msg.add(gen::TextData::obj_readable_room2_101);
            }
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::home_tools)
            ctx.msg.add(gen::TextData::obj_readable_room1_82);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::fire)
            ctx.msg.add(gen::TextData::obj_readable_room3_79);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::flower)
            ctx.msg.add(gen::TextData::obj_readable_room4_67);
        else
            BN_ERROR("Invalid readable in `room_asghouse2`");
        break;
    case RoomKind::ROOM_ASRIELROOM:
        if (_entity.getId() == ent::gen::EntityId::toys)
            ctx.msg.add(gen::TextData::obj_readable_room1_83);
        else if (_entity.getId() == ent::gen::EntityId::photo)
        {
            if (flags.true_pacifist)
                ctx.msg.add(gen::TextData::obj_readable_room2_67);
            else
                ctx.msg.add(gen::TextData::obj_readable_room2_63);
        }
        else if (_entity.getId() == ent::gen::EntityId::shoes)
            ctx.msg.add(gen::TextData::obj_readable_room3_60);
        else
    ...
    case RoomKind::ROOM_ASRIELROOM_FINAL:
        ...
        if (false) // if (_entity.getId() == ent::gen::EntityId::toys)
            ctx.msg.add(gen::TextData::obj_readable_room1_84);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::photo)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room2_75);
            else
                ctx.msg.add(gen::TextData::obj_readable_room2_72);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::drawing)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room3_66);
            else
                ctx.msg.add(gen::TextData::obj_readable_room3_63);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::chara_bed)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room4_99);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_98);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::asriel_bed)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room4_105);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_104);
        }
        else
            BN_ERROR("Invalid readable in `room_asrielroom_final`");
        break;
    case RoomKind::ROOM_CASTLE_FINALSHOEHORN:
        ctx.msg.add(gen::TextData::obj_readable_room1_86);
        break;
    case RoomKind::ROOM_CASTLE_COFFINS2:
        if (murderLv >= 16)
            ctx.msg.add(gen::TextData::obj_readable_room1_103);
        else if (flags.true_pacifist)
        {
            ctx.msg.add(gen::TextData::obj_readable_room1_96);
            ctx.msg.add(gen::TextData::obj_readable_room1_97);
            ctx.msg.add(gen::TextData::obj_readable_room1_98);
        }
        else
        {
            ctx.msg.add(gen::TextData::obj_readable_room1_90);
            ctx.msg.add(gen::TextData::obj_readable_room1_91);
            ctx.msg.add(gen::TextData::obj_readable_room1_92);
        }
        break;
    case RoomKind::ROOM_TORIELROOM:
        if (_entity.getId() == ent::gen::EntityId::bucket)
            ctx.msg.add(gen::TextData::obj_readable_room2_124);
        else if (_entity.getId() == ent::gen::EntityId::diary)
        {
            ctx.msg.add(gen::TextData::SCR_TEXT_1824);
            ctx.msg.add(gen::TextData::SCR_TEXT_1825);
            ...
            if (dialogChoice == core::DialogChoice::LEFT)
            {
                ctx.msg.add(gen::TextData::SCR_TEXT_1830);
                ctx.msg.add(gen::TextData::SCR_TEXT_1831);
                ctx.msg.add(gen::TextData::SCR_TEXT_1832);
                ctx.msg.add(gen::TextData::SCR_TEXT_1833);
            }
            // Dialog choice: Toriel's diary `NO`
            else if (dialogChoice == core::DialogChoice::RIGHT)
            {
                ctx.msg.add(gen::TextData::SCR_TEXT_1835);
            }
            else
                BN_ERROR("Invalid dialog choice=", (int)dialogChoice);
        }
        else if (_entity.getId() == ent::gen::EntityId::socks)
        {
            if (flags.true_pacifist)
            {
                ctx.msg.add(gen::TextData::obj_readable_room1_118);
                ctx.msg.add(gen::TextData::obj_readable_room1_119);
            }
            else if (_readCount > 0)
                ctx.msg.add(gen::TextData::obj_readable_room1_114);
            else
            {
                ctx.msg.add(gen::TextData::obj_readable_room1_112);
                ctx.msg.add(gen::TextData::obj_readable_room1_113);
            }
        }
        else if (_entity.getId() == ent::gen::EntityId::books)
        {
            ctx.msg.add(gen::TextData::obj_readable_room2_127);
            ctx.msg.add(gen::TextData::obj_readable_room2_128);
            ctx.msg.add(gen::TextData::obj_readable_room2_129);
        ...
        else if (_entity.getId() == ent::gen::EntityId::bed)
        {
            if (flags.true_pacifist)
            {
                ctx.msg.add(gen::TextData::obj_readable_room3_74);
                ctx.msg.add(gen::TextData::obj_readable_room3_75);
            }
            else
                ctx.msg.add(gen::TextData::obj_readable_room3_71);
        }
        else
    ...
    case RoomKind::ROOM_ASGOREROOM:
        ...
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room1_130);
            else
            {
                ctx.msg.add(gen::TextData::obj_readable_room1_125);
                ctx.msg.add(gen::TextData::obj_readable_room1_126);
            }
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::asgore_bureau)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room2_94);
            else
            {
                ctx.msg.add(gen::TextData::obj_readable_room2_90);
                ctx.msg.add(gen::TextData::obj_readable_room2_91);
            }
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::asgore_journal)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room5_80);
            else
            {
                ctx.msg.add(gen::TextData::obj_readable_room5_74);
                if (flags.true_pacifist)
                    ctx.msg.add(gen::TextData::obj_readable_room5_78);
                else
                    ctx.msg.add(gen::TextData::obj_readable_room5_75);
            }
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::asgore_chair)
            ctx.msg.add(gen::TextData::obj_readable_room1_134);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::asgore_drawing)
            ctx.msg.add(gen::TextData::obj_readable_room3_81);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::bed)
            ctx.msg.add(gen::TextData::obj_readable_room4_110);
        else
    ...
    case RoomKind::ROOM_CASTLE_THRONEROOM:
        ...
        if (false) // if (_entity.getId() == ent::gen::EntityId::throne)
            ctx.msg.add(gen::TextData::obj_readable_room1_139);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::covered_throne)
            ctx.msg.add(gen::TextData::obj_readable_room2_119);
        else
    ...
    case RoomKind::ROOM_TORHOUSE3:
        if (_entity.getId() == ent::gen::EntityId::room_under_renovations)
            ctx.msg.add(gen::TextData::obj_readable_room1_142);
        else if (_entity.getId() == ent::gen::EntityId::mirror)
        {
            if (murderLv >= 1)
                ctx.msg.add(gen::TextData::obj_readable_room4_66);
            else if (flags.true_pacifist)
                ctx.msg.add(gen::TextData::obj_readable_room4_64);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_63);
        }
        else if (_entity.getId() == ent::gen::EntityId::water_sausage)
        {
            if (flags.know_water_sausage)
                ctx.msg.add(gen::TextData::obj_readable_room2_136);
            else
                ctx.msg.add(gen::TextData::obj_readable_room2_135);
        }
        else if (_entity.getId() == ent::gen::EntityId::home_drawer)
            ctx.msg.add(gen::TextData::obj_readable_room3_83);
        else
    ...
    case RoomKind::ROOM_ASGHOUSE3:
        ...
        if (false) // if (_entity.getId() == ent::gen::EntityId::room_under_renovations)
            ctx.msg.add(gen::TextData::obj_readable_room1_143);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::flower)
            ctx.msg.add(gen::TextData::obj_readable_room2_111);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::mirror)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room4_73);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_70);
        }
        else
    ...
    case RoomKind::ROOM_KITCHEN:
        if (_entity.getId() == ent::gen::EntityId::fridge)
            ctx.msg.add(gen::TextData::obj_readable_room1_144);
        else if (_entity.getId() == ent::gen::EntityId::pie)
        {
            if (flags.true_pacifist)
                ctx.msg.add(gen::TextData::obj_readable_room2_144);
            else if (flags.got_bscotch_pie != GameFlags::GotBscotchPie::INIT)
                ctx.msg.add(gen::TextData::obj_readable_room2_141);
            else
                ctx.msg.add(gen::TextData::obj_readable_room2_140);
        }
        else if (_entity.getId() == ent::gen::EntityId::sink)
            ctx.msg.add(gen::TextData::obj_readable_room3_84);
        else if (_entity.getId() == ent::gen::EntityId::cupboard)
        {
            if (murderLv >= 1)
                ctx.msg.add(gen::TextData::obj_readable_room4_77);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_76);
        }
        else if (_entity.getId() == ent::gen::EntityId::stove)
        {
            if (flags.status_toriel == GameFlags::StatusToriel::KILLED)
                ctx.msg.add(gen::TextData::obj_readable_room4_79);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_78);
        }
        else
    ...
    case RoomKind::ROOM_KITCHEN_FINAL:
        ...
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room1_151);
            else
                ctx.msg.add(gen::TextData::obj_readable_room1_147);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::sink)
            ctx.msg.add(gen::TextData::obj_readable_room3_85);
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::cupboard)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room4_84);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_83);
        }
        else if (false) // else if (_entity.getId() == ent::gen::EntityId::stove)
        {
            if (murderLv >= 16)
                ctx.msg.add(gen::TextData::obj_readable_room4_91);
            else
                ctx.msg.add(gen::TextData::obj_readable_room4_90);
        }
        else
    ...
    case RoomKind::ROOM_BASEMENT5: {
        ...
        {
        case 0:
            ctx.msg.add("killed Toriel (first)");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            persist.Toriel.TS = 0;
            persist.Toriel.TK = 1;
            break;
        case 1:
            ctx.msg.add("killed Toriel (twice)");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            persist.Toriel.TS = 0;
            persist.Toriel.TK = 2;
            break;
        case 2:
            ctx.msg.add("killed Toriel (3+ times)");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            persist.Toriel.TS = 0;
            persist.Toriel.TK = 3;
            break;
        case 3:
            ctx.msg.add("spare->kill Toriel (first)");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            persist.Toriel.TS = 1;
            persist.Toriel.TK = 1;
            ...
            break;
        case 4:
            ctx.msg.add("spare->kill Toriel (not first)");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            persist.Toriel.TS = 1;
            persist.Toriel.TK = 1;
            ...
            break;
        case 5:
            ctx.msg.add("genocide");
            flags.status_toriel = GameFlags::StatusToriel::KILLED;
            flags.murderlevel_override = 2;
            break;
        case 6:
            ctx.msg.add("spared Toriel, killed monster(s)");
            ...
            break;
        case 7:
            ctx.msg.add("kill->spare Toriel (first)");
            flags.status_toriel = GameFlags::StatusToriel::SPARED;
            persist.Toriel.TS = 1;
            persist.Toriel.TK = 1;
            persist.Flowey.FloweyExplain1 = false;
