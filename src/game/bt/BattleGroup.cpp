...
constexpr bn::array<bn::fixed_point, 3> EMPTY_POSITIONS = {};
constexpr bn::array<bn::fixed_point, 3> TEST_POSITIONS = {bn::fixed_point{-60, 0}, {0, 0}, {60, 0}};

using Mob = mob::MonsterKind;
