...
static constexpr const bn::sprite_palette_item* COLORS[(int)TextColorKind::TOTAL_COUNT] = {
    ...
    &bn::sprite_palette_items::pal_ftmain_white,  &bn::sprite_palette_items::pal_ftmain_gray,
    &bn::sprite_palette_items::pal_ftmain_yellow, &bn::sprite_palette_items::pal_ftmain_black,
    &bn::sprite_palette_items::pal_ftmain_blue,   &bn::sprite_palette_items::pal_ftmain_orange,
    &bn::sprite_palette_items::pal_ftmain_azure,  &bn::sprite_palette_items::pal_ftmain_magenta,
    &bn::sprite_palette_items::pal_ftmain_pink,
};
