...
PYTHON      :=  python
SOURCES     :=  src $(USERBUILD)/src src/asset src/core src/scene src/scene/test src/game src/game/mngr src/game/ent src/game/cpnt src/game/menu src/mtile src/debug lib/src/crc32 butano/common/src
