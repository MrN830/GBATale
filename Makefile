...
PYTHON      :=  python
SOURCES     :=  src $(USERBUILD)/src src/asset src/core src/scene src/scene/test src/game src/game/ent src/game/cpnt src/game/cpnt/inter src/game/cpnt/ev src/game/task src/game/sys src/game/cmd src/game/coll src/game/menu src/game/bt src/game/bt/state src/game/bt/mob src/mtile src/debug lib/src/crc32 butano/common/src
